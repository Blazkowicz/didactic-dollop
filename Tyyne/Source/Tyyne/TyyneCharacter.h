...
#include "TyyneCharacter.generated.h"

UCLASS(config=Game)
class ATyyneCharacter : public ACharacter, public IAbilitySystemInterface
{
	GENERATED_BODY()
...
public:
	...
	//Function to bind Attribute Changed delegate. Calls On Health Changed.
